...
Status: `OPERATOR-APPROVED VISUAL MODEL / IMMUTABLE SOURCE SET FOR CANONICAL ASSET RELEASE 1.0.0`.
...
Do not use Blender viewport recordings, grids, axes, coordinate text, or XYZ gizmos in public presentation. Platform deployment remains separately verified from this asset contract.
